 ...
 *
 *	Descrição: Página que lista os estados civis do sistema.
 *
...
<meta name="description" content="Sistema CBIOT - Estado Civil" />
...
<body>
	...
	$sql = "SELECT count(id) FROM estado_civil WHERE ".$sql_params;
	$result = query($sql);
	...
	switch($orderby){
		...
		case 2:		$sql_params .= " ORDER BY id DESC";
					break;
		case 3:		$sql_params .= " ORDER BY estado_civil ASC";
					break;
		case 4:		$sql_params .= " ORDER BY estado_civil DESC";
					break;
		default: 	$sql_params .= " ORDER BY id ASC";
	}
	
	//pesquisa conforme parametros especificados
	$sql = "SELECT * FROM estado_civil WHERE ".$sql_params.
	...
	<div class="row" style="padding-bottom: 5px;">
		...
		<div class="col-md-4">
			<?php
				$sql = urlencode("SELECT * FROM estado_civil");
				$title = urlencode("ESTADOS CIVIS CADASTRADOS NO SISTEMA");
				$page = "print_data.php";
	  ...
	  <table class="table table-striped table-hover">
		<thead>
			...
			<th><?php 	$orderlink = "";
						...
						echo "<a href=\"".add_param($orderlink,"page",$page)."\">";?>Estado Civil</a></th>
		</thead>
