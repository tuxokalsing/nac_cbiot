 ...
 *
 *	Descrição: Página que lista os estados do sistema.
 *
...
<meta name="description" content="Sistema CBIOT - Estados" />
...
<body>
	...
	$sql = "SELECT count(id) FROM estado WHERE ".$sql_params;
	$result = query($sql);
	...
	$sql = "SELECT * FROM estado WHERE ".$sql_params.
	...
	<div class="row" style="padding-bottom: 5px;">
		...
		<div class="col-md-4">
			<?php
				$sql = urlencode("SELECT * FROM estado");
				$title = urlencode("ESTADOS CADASTRADOS NO SISTEMA");
				$page = "print_data.php";
