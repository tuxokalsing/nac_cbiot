 ...
 *
 *	Descrição: Página de cadastro de usuários para administração
...
$cat = $_GET['cat'];						// categoria do usuario a ser criado
	  ...
	  <div class="panel panel-info">
	    ...
	    <div class="panel-body">
		  ...
		  <div class="form-group">
			...
			<label id="input_emissao_label" for="input_emissao" class="col-sm-2 control-label col-form-cbiot <?php if(!empty($data_rgErr)) { echo "has-error"; } ?>">Data e Emissor:</label>
	...
	<div id="wrap">
		...
		<div class="container">
			<div class="alert alert-success noprint" style="text-align: center; font-weight: bold;">
				...
				- <a href='".LINK_DOCUMENTO_2."' target='_blank'>Poíticas Gerais do Cbiot</a> <br>"); ?>
			</div>
			<div class="row noprint" style="padding-bottom: 20px;">
				<div class="col-md-4">
					<a href="new_user.php<?php echo "?cat=".$cat; ?>" class="btn btn-primary btn-block" alt="<?php echo8("Novo Usuário"); ?>">
						<span class="glyphicon glyphicon-user"></span> <?php echo8("Novo Usuário"); ?>
					</a>
				</div>
				<div class="col-md-4">
					<a href="edit_user.php<?php echo "?id=".$new_user->id; ?>" class="btn btn-primary btn-block" alt="<?php echo8("Alterar Dados do Usuário"); ?>">
						<span class="glyphicon glyphicon-edit"></span> <?php echo8("Alterar Dados do Usuário"); ?>
					</a>
				</div>
				<div class="col-md-4">
			...
			<div class="panel panel-info noprint">
				...
				<div class="panel-body">
					...
					<div class="row">
						<label class="col-sm-2 control-label col-form-cbiot"><?php echo8("Data de Expiração:"); ?></label>
						<div class="col-sm-4">
							<p><?php echo $new_user->data_expiracao;?></p>
						</div>
					</div> <!-- /row -->
				</div> <!-- /panel body -->
			</div> <!-- /panel -->
			...
			<div class="panel panel-info noprint">
				...
				<div class="panel-body">
					...
					<div class="row">
						...
						<div class="col-sm-11">
							<p><?php echo $new_user->acesso->hash;?></p>
						</div>
					</div> <!-- /row -->
				</div> <!-- /panel-body -->
			</div> <!-- /panel -->
...
<!-- A parte abaixo só sera vista na impressão -------------------------------------------------------->
			...
			<div class="panel panel-info toprint">
				...
				<div class="panel-body">
					<table width="100%" border='0'>
						Eu, <?php echo $new_user->nome;?>, concordo com os termos dos documentos apresentados durante o cadastro.
