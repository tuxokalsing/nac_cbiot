 ...
 *
 *	Descrição: Página que lista os tipos de contato do sistema.
 *
...
<body>
	...
	$sql = "SELECT count(id) FROM tipos_contato WHERE ".$sql_params;
	$result = query($sql);
	...
	$sql = "SELECT * FROM tipos_contato WHERE ".$sql_params.
	...
	<div class="row" style="padding-bottom: 5px;">
		...
		<div class="col-md-4">
			<?php
				$sql = urlencode("SELECT * FROM tipos_contato");
				$title = urlencode("TIPOS DE CONTATO CADASTRADOS NO SISTEMA");
				$page = "print_data.php";
	  ...
	  <table class="table table-striped table-hover">
		<thead>
			...
			<th><?php 	$orderlink = "";
						...
						echo "<a href=\"".add_param($orderlink,"page",$page)."\">";?>Tipo de Contato</a></th>
		</thead>
