 ...
 *
 *	Descrição: Página que lista os tipos de dispositivo do sistema.
 *
...
<body>
	...
	$sql = "SELECT count(id) FROM tipos_dispositivo WHERE ".$sql_params;
	$result = query($sql);
	...
	$sql = "SELECT * FROM tipos_dispositivo WHERE ".$sql_params.
	...
	<div class="row" style="padding-bottom: 5px;">
		...
		<div class="col-md-4">
			<?php
				$sql = urlencode("SELECT * FROM tipos_dispositivo");
				$title = urlencode("TIPOS DE DISPOSITIVOS CADASTRADOS NO SISTEMA");
				$page = "print_data.php";
